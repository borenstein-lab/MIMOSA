...
**Update fall 2019**: A new version of MIMOSA is now available, [MIMOSA2](http://borensteinlab.com/software_MIMOSA2.html)! MIMOSA2 has improved analysis, reference, and input options. It can be run either from a web server at http://elbo-spice.gs.washington.edu/MIMOSA2shiny/, or as an R package installable from http://github.com/borenstein-lab/mimosa2 .
...
if this code runs with no errors (warnings are OK) and generates results for a single metabolite, then MIMOSA is installed and working.
...
Questions can be sent to cnoecker [at] uw.edu.
